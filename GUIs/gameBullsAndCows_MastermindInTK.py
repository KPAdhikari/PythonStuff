...
The Algorithm is explained in detail in our chapter "Mastermind / Bulls and Cows" (https://www.python-course.eu/mastermind.php) in Advanced Topics. You can also find the code for the module combinatorics.
